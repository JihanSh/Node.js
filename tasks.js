// const fs = require("fs");fs.readFile("database.json", (error, data) => {
//   if (error) {
//     console.error(error);
//   } else {
...
//   tasks,
//   completedTasks: ["Task 1: Learn Node basics"],
// }; // update the database object as needed
// const datas = JSON.stringify(updatedDatabase);

// fs.writeFile('database.json', datas, (error) => {
//   if (error) {
//     console.error(error);
//   } else {
...
function help() {
  ...
  console.log(
    "     --remove <task number>             removes the task of this number\n"
  );
  console.log(
    '     --edit <new task>                  Changes the last task to "new task"\n'
  );
  console.log(
    '     --edit <task number> <new task>    Changes this task to "new task"\n'
  );
  console.log(
    "     --check <task number>              Marks this task as done\n"
  );
  console.log(
    "     --uncheck <task number>            Marks this task as undone\n"
  );
  console.log(
